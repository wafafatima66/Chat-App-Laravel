...
$(document).ready(function(){
	  //var results = [];  
	  var totalOkResults = $("#totalOkResults").val();
	  var totalNGResults = $("#totalNGResults").val();
	  var totalPendingResults = $("#totalPendingResults").val();
	  var results = [totalOkResults, totalNGResults, totalPendingResults]; 
      console.log(results[totalPendingResults]);
  ...
  var chart6 = new Chart(document.getElementById('statistics-chart-6').getContext("2d"), {
    ...
    data: {
      ...
      datasets: [{
        data: [$("#totalOkResults").val(), $("#totalNGResults").val(), $("#totalPendingResults").val()],
        backgroundColor: ['#02BC77', '#d9534f', '#38587D'],
