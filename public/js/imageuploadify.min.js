		...
		this.each(function() {
			...
			$(self).closest("form").on("submit", function(event) {
				...
				$.ajax({
		            ...
		            //data: formData,
		            //dataType: 'json',
		            url: $('#url').val()+"/issue/"+$('#issue_id').val(),
