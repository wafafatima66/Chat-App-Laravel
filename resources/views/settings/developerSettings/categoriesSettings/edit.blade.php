   ...
   <div class="col-lg-9 settgs_right_content">
    <div class="card mb-4 no_border">
      <div class="card-body padding_left_right">
       <h6 class="card_body_header">Category Edit</h6>
       <div class="row noticeformholder">

          {!! Form::open(['route' => ['category-update', $catid], 'enctype' => 'multipart/form-data', 'id' => 'wikieditform', 'class' => 'pl-3'])!!}
          {{ method_field('put') }}
          ...
          <div class="form-group">
           <label class="col-form-label text-sm-right">Category Name</label>
            <div class="">
              ...
              <input type="text"  name="category_name" id="category_name" class="controls  form-control {{ $errors->has('category_name') ? ' is-invalid' : '' }}" placeholder="News Category Name" value="<?php if(!empty($Catdetails->category_name)){ echo $Catdetails->category_name;} ?>">
          ...
          <div class="form-group">
           <label class="col-form-label text-sm-right">Points</label>
            <div class="">
              ...
              <input type="text"  name="points" id="points" class="controls  form-control {{ $errors->has('points') ? ' is-invalid' : '' }}" placeholder="points" value="<?php if(!empty($Catdetails->points)){ echo $Catdetails->points;} ?>">
          ...
          <div class="form-group">
           ...
           @if ($errors->has('note'))
           <span class="invalid-feedback" role="alert">
            <span class="messages"><strong>{{ $errors->first('details') }}</strong></span>
          </span>
          @endif

          <div id="editSection"></div>
          <!-- <button id="dummycontentaddbtn">Add Dummy Content</button> -->
          <textarea class="form-control {{ $errors->has('details') ? ' is-invalid' : '' }}" id="content2bSavedHolder" name="details" style="display:none"></textarea>
