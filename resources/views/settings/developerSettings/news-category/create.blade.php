   ...
   <div class="col-lg-9 settgs_right_content">
    <div class="card mb-4 no_border">
      <div class="card-body padding_left_right">
       <h6 class="card_body_header">News Category Add</h6>
       <div class="row noticeformholder">

          {!! Form::open(['route' => ['news-category-create'], 'enctype' => 'multipart/form-data', 'id' => 'wikieditform', 'class' => 'pl-3'])!!}
          {{ method_field('post') }}
          ...
          <div class="form-group">
           <label class="col-form-label text-sm-right">Category Name</label>
            <div class="">
              ...
              <input type="text"  name="name" id="name" class="controls  form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="News Category Name" value="">
