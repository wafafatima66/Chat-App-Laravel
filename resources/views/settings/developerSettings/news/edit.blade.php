   ...
   <div class="col-lg-9 settgs_right_content">
    <div class="card mb-4 no_border">
      <div class="card-body padding_left_right">
       <h6 class="card_body_header">News Edit</h6>
       <div class="row noticeformholder">

        {!! Form::open(['route' => ['news-update', $newsid], 'enctype' => 'multipart/form-data', 'id' => 'wikieditform', 'class' => 'pl-3'])!!}
        {{ method_field('put') }}
        ...
        <div class="form-group">
         ...
         <div class="">
          ...
          <input type="text"  name="title" id="title" class="controls  form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="News Title" value="<?php if(!empty($newsdetails->title)){ echo $newsdetails->title;} ?>">
      ...
      <div class="form-group">
        ...
        <select class="custom-select {{ $errors->has('category_id') ? ' is-invalid' : '' }}" name="category_id">
          ...
          <option value="{{$newCat->id}}"
            ...
            @if($newsdetails->category_id == $newCat->id)
            selected
            @endif
            @endif
            >{{$newCat->name}}</option>
      ...
      <div class="form-group row pt-5">
        ...
        <div class="col-md-2 ml-sm-auto text-left">
          <a href="#" class="btn  btn-success dtb_custom_btn_default" title="Remove" data-toggle="modal" data-target="#appdeletedmodal" style="padding: 4px 19px;font-size: 14px;color:red;border-color: red">Delete</a>
        </div>

        <div class="col-md-10 ml-sm-auto pull-right">
          <input type="submit" class="col-lg-5 btn btn-success dtb_custom_btn_default pull-right" value="Update">
        </div>
      </div>
...
<!--         <div class="modal-body">
        ...
        <div class="modal-footer">
          ...
          <button  value="{{ $newsdetails->id ?? '' }}" type="button" class="btn btn-danger appdelbtn" data-dismiss="modal" data="{{ $newsdetails->id }}" >YES</button>
...
<textarea id="wikidescsrc" rows="10" cols="82" style="display: none;">
  <?php if (!empty($newsdetails)) { echo $newsdetails->detail;} ?>
</textarea>
