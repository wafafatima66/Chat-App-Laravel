  ...
  <div class="col-lg-12">
      ...
      <!--   <h6 class="card_body_header" style="padding-left: 0px;float: left">Add Priority</h6>
        ...
        <span class="text-left" style="margin-right: 68%;">
          <h6 class="card_body_header" style="padding-left: 0px;float: left">Edit Priority</h6>
        </span>
       ...
       <div class="row noticeformholder">
          ...
          {!! Form::open(['route' => ['priority-update', $priorityid], 'enctype' => 'multipart/form-data', 'id' => 'wikieditform', 'class' => 'pl-3'])!!}
          {{ method_field('put') }}
       ...
       <div class="form-row">
          <div class="form-group col mb-0">
            ...
            <input required type="text" id="edit_priority_name" name="priority_name" value="{{$priorityDetails->priority_name}}" class="form-control required" placeholder="">
          ...
          <div class="form-group col pl-4">
            ...
            <span class="oldcolrolabel">
              ...
              <input type="button" class="btn editcolors" name="oldercolor" value="{{$priorityDetails->priority_name}}" style="background: {{$priorityDetails->color}};">
