      ...
      'preview' : '#image-previewer',
         ...
         <div class="row">
            ...
            <div class="col-md-8" style="padding: 0px 12px !important">
                    ...
                    <h4 class="px-0 ml-3" style="color: black">Edit Screen</h4><br>
 
                    {!! Form::open(['route' => ['screenupdate', $id,$screengroupid,$screenid], 'method' => 'PUT','files' => true, 'enctype' => 'multipart/form-data','id' => 'screenupdateform','class' => 'form-horizontal'])!!}
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                               ...
                               <div class="">
                                <input  name="function_group_name" type="text" class="form-control  {{ $errors->has('function_group_name') ? ' is-invalid' : '' }}"  value="{{ old('screen_name') ?? $screendetails->function_group_name }}">
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                               ...
                               <div class="">
                                <input  name="screen_name" type="text" class="form-control  {{ $errors->has('screen_name') ? ' is-invalid' : '' }}"  value="{{ old('screen_name') ?? $screendetails->screen_name }}">
...
{{--                             <div class="col-md-4">
                              <div class="form-group">
                               ...
                               <div class="">
                                <select name="app_id" class="custom-select NoborderRadius" id="editappselect" style="height: 40px;">
                                  ...
                                  @foreach($applist as $appslist)
                                  <option value="{{ $appslist->id }}" @php
                                    if ($appslist->id == $screendetails->app_id) { echo "selected"; }else{}
                                  @endphp >{{ $appslist->app_name }}
                                  </option>
                                @endforeach
                              </select>
                              </div>
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <div class="">
                                 <input type="text" name="estimate" class="form-control  {{ $errors->has('estimate') ? ' is-invalid' : '' }}"  value="{{ old('estimate') ?? $screendetails->estimate }}">
                        ...
                        <div class="row">
                              <div class="col-md-12">
                                <div class="form-group"  style="margin-bottom: 0px;">
                                  <label class="col-form-label text-sm-right">Screen attachment</label>
                                  <div class="">
                                </div>
                              </div>
                              <div class="screnattachementholder">
                               <ul>
                                 <li>

                                   {{--  @php $image_path = ""; @endphp
                                      @if(!empty($screendetails->image_url))
                                        @php $image_path = url($screendetails->image_url); @endphp
                                        <img src="//{{substr($image_path,env('AWS_BASE_URL'))}}" alt="">
                                      @else
                                    @endif --}}
                                    ...
                                    <?php
                                    if(!empty($screendetails->image_url)){ ?>
                                    {{-- <img src=" {{ URL::to('/') }}/uploads/screenattachment/{{ $screendetails->image_url ?? '' }}" alt="screen"> --}}
                                    <img src="{{ $screendetails->image_url ?? '' }}" alt="screen">
                                   <?php }else{
                                    echo "";
                                    }
                              ...
                              <input type="text" value="{{ $screendetails->image_url ?? '' }}" name="oldattachment" style="display: none;">
                                ...
                                <div class="form-group mb-0">
                                  ...
                                  <input type="file" id="file-input" name="image_url" class="form-control" value="Select" placeholder="Select" value="{{ $screendetails->image_url ?? '' }}" >
                                </div>
                                </div>
                                <div class="preview">
      ...
      <textarea id="screendtail" rows="10" cols="82" style="display: none;"><?php if (!empty($screendetails&&!empty($screendetails->detail))) { echo $screendetails->detail;} else { echo ' *** '; } ?>
      </textarea>
...
.screnattachementholder {
    width: 100%;
    overflow: hidden;
}
.screnattachementholder ul {
    padding: 0;
    margin-bottom: 14px;
    /* display: block; */
    float: left;
}
.screnattachementholder ul li {
    list-style: none;
    width: 116px;
    border: 2px solid #ffffff;
    max-height: 146px;
}
.screnattachementholder ul li img {
    width: 100%;
    height: auto;
}
</style>
...
<script type="text/javascript">
          ...
          //initial content
          var text = document.getElementById('screendtail').value,
      ...
      error: function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        $("#screenupdateform").submit(function(e){;
